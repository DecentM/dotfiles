...
export const memoryToolExecutionStore: IToolExecutionStore & {
  ...
  logToolExecution: async (data: ToolExecutionInput): Promise<IToolExecution | null> => {
...
export const memorySessionEventStore: ISessionEventStore & {
  ...
  logSessionEvent: async (data: SessionEventInput): Promise<ISessionEvent | null> => {
  ...
  getSessionLogs: async (filters?: GetSessionLogsFilters): Promise<ISessionEvent[]> => {
...
export const memoryChatMessageStore: IChatMessageStore & { clear: () => void } = {
  logChatMessage: async (data: ChatMessageInput): Promise<IChatMessage | null> => {
  ...
  getChatMessages: async (filters?: GetChatMessagesFilters): Promise<IChatMessage[]> => {
...
export const memoryPermissionEventStore: IPermissionEventStore & {
  ...
  logPermissionEvent: async (data: PermissionEventInput): Promise<IPermissionEvent | null> => {
...
export const memoryCommandExecutionStore: ICommandExecutionStore & {
  ...
  logCommandExecution: async (data: CommandExecutionInput): Promise<ICommandExecution | null> => {
