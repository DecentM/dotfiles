...
import type { LogEntry, Decision } from "./types";
...
interface TestDb {
  ...
  updateLogEntry: (id: number, resultSummary: string, durationMs: number) => void;
  ...
  getPatternStats: (
    ...
    limit?: number
  ) => Array<{ patternMatched: string | null; decision: string; count: number }>;
...
const createTestDb = (): TestDb => {
  ...
  const updateLogEntry = (id: number, resultSummary: string, durationMs: number): void => {
    db.run(
  ...
  const getOverallStats = (filter: { since?: Date; decision?: Decision } = {}) => {
  ...
  const getTopDeniedOperations = (since?: Date, limit = 10) => {
    ...
    return db.query(query).all(...params) as Array<{ operation: string; count: number }>;
  };

  const getLogs = (filter: { since?: Date; decision?: Decision; limit?: number } = {}) => {
...
describe("getOverallStats", () => {
  ...
  describe("basic statistics", () => {
    ...
    test("counts total operations", () => {
      testDb.logOperation({ operation: "a", patternMatched: "a", decision: "allow" });
      testDb.logOperation({ operation: "b", patternMatched: "b", decision: "allow" });
      testDb.logOperation({ operation: "c", patternMatched: null, decision: "deny" });
  ...
  describe("filtering", () => {
    test("filters by decision", () => {
      testDb.logOperation({ operation: "a", patternMatched: "a", decision: "allow" });
      testDb.logOperation({ operation: "b", patternMatched: null, decision: "deny" });
      testDb.logOperation({ operation: "c", patternMatched: null, decision: "deny" });
...
describe("getPatternStats", () => {
  ...
  test("groups by pattern and decision", () => {
    testDb.logOperation({ operation: "a", patternMatched: "pattern1", decision: "allow" });
    testDb.logOperation({ operation: "b", patternMatched: "pattern1", decision: "allow" });
    testDb.logOperation({ operation: "c", patternMatched: "pattern2", decision: "deny" });
  ...
  test("orders by count descending", () => {
    testDb.logOperation({ operation: "a", patternMatched: "rare", decision: "allow" });
    testDb.logOperation({ operation: "b", patternMatched: "common", decision: "allow" });
    testDb.logOperation({ operation: "c", patternMatched: "common", decision: "allow" });
    testDb.logOperation({ operation: "d", patternMatched: "common", decision: "allow" });
  ...
  test("respects limit parameter", () => {
    testDb.logOperation({ operation: "a", patternMatched: "p1", decision: "allow" });
    testDb.logOperation({ operation: "b", patternMatched: "p2", decision: "allow" });
    testDb.logOperation({ operation: "c", patternMatched: "p3", decision: "allow" });
  ...
  test("handles null pattern", () => {
    testDb.logOperation({ operation: "a", patternMatched: null, decision: "deny" });
    testDb.logOperation({ operation: "b", patternMatched: null, decision: "deny" });
...
describe("getTopDeniedOperations", () => {
  ...
  test("only counts denied operations", () => {
    testDb.logOperation({ operation: "allowed:op", patternMatched: "p", decision: "allow" });
    testDb.logOperation({ operation: "denied:op", patternMatched: null, decision: "deny" });
  ...
  test("groups and counts by operation", () => {
    testDb.logOperation({ operation: "volume:create", patternMatched: null, decision: "deny" });
    testDb.logOperation({ operation: "volume:create", patternMatched: null, decision: "deny" });
    testDb.logOperation({ operation: "volume:remove", patternMatched: null, decision: "deny" });
  ...
  test("orders by count descending", () => {
    testDb.logOperation({ operation: "rare:op", patternMatched: null, decision: "deny" });
    testDb.logOperation({ operation: "common:op", patternMatched: null, decision: "deny" });
    testDb.logOperation({ operation: "common:op", patternMatched: null, decision: "deny" });
    testDb.logOperation({ operation: "common:op", patternMatched: null, decision: "deny" });
  ...
  test("respects limit parameter", () => {
    testDb.logOperation({ operation: "op1", patternMatched: null, decision: "deny" });
    testDb.logOperation({ operation: "op2", patternMatched: null, decision: "deny" });
    testDb.logOperation({ operation: "op3", patternMatched: null, decision: "deny" });
...
describe("getLogs", () => {
  ...
  describe("basic retrieval", () => {
    ...
    test("orders by timestamp descending (newest first)", () => {
      testDb.logOperation({ operation: "first", patternMatched: "p", decision: "allow" });
      // Small delay to ensure different timestamps
      testDb.logOperation({ operation: "second", patternMatched: "p", decision: "allow" });
  ...
  describe("filtering", () => {
    ...
    test("respects limit parameter", () => {
      testDb.logOperation({ operation: "a", patternMatched: "a", decision: "allow" });
      testDb.logOperation({ operation: "b", patternMatched: "b", decision: "allow" });
      testDb.logOperation({ operation: "c", patternMatched: "c", decision: "allow" });
